...
const CallHistoryDetail: React.FC = ({ route }: any) => {  
  ...
  const calTypeIcon = callDetails.type === 0 ? (  
    <MaterialCommunityIcons name="arrow-bottom-left" size={16} color="#AACD05" style={{ height: 24, marginRight: 2}}  />  
  ) : (  
    <MaterialCommunityIcons name="arrow-top-right" size={16} color="#EC5079" style={{ height: 24, marginRight: 2}} />  
  );  
      ...
      <View style={styles.detailsContainer}>  
        <View style={styles.detailsRow}>  
          ...
          <View style={styles.detailsColumnValues}>  
            <Text style={styles.detailValue}>{new Date(callDetails.startTime).toLocaleString()}</Text>  
            ...
            <Text style={styles.detailValue}>{callDetails.operator.phoneNumber}</Text>  
            <Text style={styles.detailValue}>{callDetails.contact}</Text>  
            <Text style={styles.detailValue}>{callDetails.talkDuration} 秒</Text>  
            <Text style={styles.detailValue}>{callDetails.ringDuration} 秒</Text>  
          </View>  
        </View>  
      </View>  
    </View>  
